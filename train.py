...
from src.pipelines.flux.pipeline_flux_controlnet import FluxControlNetPipeline
from src.training_utils import compute_density_for_timestep_sampling, free_memory
from src.utils import check_min_version, is_wandb_available, make_image_grid
from src.utils.hub_utils import load_or_create_model_card, populate_model_card
from src.utils.import_utils import is_torch_npu_available, is_xformers_available
from src.utils.torch_utils import is_compiled_module
...
def main(args):
    ...
    with accelerator.main_process_first():
        ...
        new_fingerprint = Hasher.hash(args.hash)
        train_dataset = train_dataset.map(
            # compute_embeddings_fn, batched=True, new_fingerprint=None, batch_size=10
            # compute_embeddings_fn, batched=True, new_fingerprint=new_fingerprint, batch_size=30
